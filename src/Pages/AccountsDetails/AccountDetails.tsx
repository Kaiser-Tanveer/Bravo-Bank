    ...
    return (
        <div className='bg-gradient-to-br from-gray-300 to-gray-100 pt-12 lg:pt-0 lg:pb-20'>
            ...
            <div className='grid md:grid-cols-2 lg:grid-cols-3 gap-6 m-6 group'>
                {
                    details?.facilities?.map((facility: { title: string, details: string }) => <div className='bg-gradient-to-r  group-hover:h-[80vh] hover:overflow-y-scroll h-40 from-primary to-sky-500 p-1 rounded-lg shadow-lg shadow-gray-700 hover:from-sky-500 hover:to-primary duration-700 overflow-hidden group-hover:blur-sm group-hover:scale-[80%] hover:!blur-0 hover:!scale-110'>
